...
def load_images(card_images):
    ...
    # for each suit retrieve the image of cards
    for suit in suits:
        # first the number of cards 2 to 10
...
def score_hand(hand):
    ...
    # Only one ace can have a value 11, and this will be reduce to 1 if the hand would bust
    score = 0
    ace = False
